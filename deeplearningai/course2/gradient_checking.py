...
def gradient_check(x, theta, epsilon = 1e-7):
    ...
    gradapprox = (J_plus-J_minus) / (2*epsilon)    # Step 5 NB BRACKETS AROUND 2*epsilon!
    print(gradapprox)
    ### END CODE HERE ###
    ...
    ### START CODE HERE ### (approx. 1 line)
    numerator = np.linalg.norm(x - gradapprox)                   # Step 1'
    denominator = np.linalg.norm(x) + np.linalg.norm(gradapprox) # Step 2'
